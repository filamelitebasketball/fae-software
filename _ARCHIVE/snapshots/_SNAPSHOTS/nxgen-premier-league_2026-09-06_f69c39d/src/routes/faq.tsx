...
export const Route = createFileRoute("/faq")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "https://nxgenpremierleague.lovable.app/faq" }],
  }),
  component: FaqPage,
});
...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      { q: "How much is the entry fee?", a: "Rising Stars ₱30,000/team · Legacy ₱35,000/team · 3x3 ₱8,000/team · King of the Court ₱2,000/player." },
