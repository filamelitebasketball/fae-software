...
const DIVISIONS: Record<string, DivisionRules> = {
  "rising-stars": {
    ...
    eligibility: "9U – 21U.",
    entryFee: "₱30,000 per team, due 10 days before opening night.",
    playoffs:
  ...
  "legacy": {
    ...
    entryFee: "₱35,000 per team, due 10 days before opening night.",
    playoffs:
  ...
  "3x3": {
    ...
    entryFee: "₱8,000 per team, due 10 days before opening night — same across all three age tiers.",
  ...
  "king-of-the-court": {
    ...
    entryFee: "₱2,000 per player, due 10 days before opening night — same across all three age tiers.",
...
export const Route = createFileRoute("/divisions/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      links: [{ rel: "canonical", href: `https://nxgenpremierleague.lovable.app/divisions/${d.slug}` }],
    };
  },
