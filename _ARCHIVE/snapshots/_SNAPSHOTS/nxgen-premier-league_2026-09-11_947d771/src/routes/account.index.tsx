    ...
    >
      <div className="acc-wrap">
        ...
        <div className="acc-cols">
          ...
          <section className="inf-group">
                  ...
                  <div key={r.id} className="acc-row">
                    ...
                    <div className="acc-row-r">
                      ...
                      {(() => {
                        ...
                        return rr ? (
                          <p className="acc-sub">
                            Refund request: <b>{rr.status}</b>
                            {rr.approved_amount_cents != null && ` · ${fmtMoney(rr.approved_amount_cents)} credited`}
                          </p>
                        ) : (
                          <button type="button" className="btn btn-ghost btn-xs" onClick={() => openRefund(r)}>
                            Request refund
                          </button>
                        );
                      })()}
            ...
            <p className="acc-fine">
              NXGEN follows a <b>no-refund policy</b>. Once a payment is transacted it stays with the league — approved
              requests are converted into league credit, a transfer to another division, or carried over to next season.
              Read the <Link to="/legal/refund-policy">refund policy</Link>.
            </p>
          </section>
        ...
        <section className="inf-group acc-card-sec">
          ...
          <h2 className="acc-card-h">Built for Instagram &amp; Facebook</h2>
          <p className="acc-sub">
