...
function ProfileDashboard() {
  ...
  const load = useCallback(async () => {
    ...
    const [pRes, rRes, wRes, lRes, sRes] = await Promise.all([
      supabase.from("profiles").select("id, full_name, phone, avatar_url, photo_url, bio, position, jersey_number, division, height_cm, weight_kg, date_of_birth, highlights, stats, instagram_handle, facebook_handle, twitter_handle, tiktok_handle").eq("id", uid).maybeSingle(),
  ...
  const save = async () => {
    ...
    }).eq("id", draft.id).select("id, full_name, phone, avatar_url, photo_url, bio, position, jersey_number, division, height_cm, weight_kg, date_of_birth, highlights, stats, instagram_handle, facebook_handle, twitter_handle, tiktok_handle").single();
