...
import {
  Flame, Target, Users, Zap, Shield, Layers, Trophy, Crown, Star,
  TrendingUp, Swords, Sparkles, Lock, ChevronDown,
} from "lucide-react";
...
const ICONS: Record<string, LucideIcon> = {
  Flame, Target, Users, Zap, Shield, Layers, Trophy, Crown, Star, TrendingUp, Swords, Sparkles,
};
...
const SITE = "https://nxgenpremierleague.lovable.app";
...
export function drawAchievement(
  ...
  ctx.fillText("nxgenpremierleague.lovable.app", cx, 1010);
}
