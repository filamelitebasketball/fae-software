...
export const Route = createFileRoute("/schedule")({
  head: () => ({
    meta: [
      { title: "Court Schedule — F.A.E. Court, Lipa City" },
      {
        name: "description",
        content:
          "Live court availability at F.A.E. Court, Lipa City. See open basketball, volleyball and pickleball slots for the next 7 days before you book.",
      },
      { property: "og:title", content: "Court Schedule — F.A.E. Court, Lipa City" },
      {
        property: "og:description",
        content: "Live availability for every court at F.A.E. Court. Pick a sport and day to see open slots.",
      },
    ],
  }),
