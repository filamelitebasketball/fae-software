...
export const Route = createFileRoute("/legal/privacy")({
  ...
  component: () => (
    <LegalDoc title="Privacy Policy & Media Consent" updated="2026-07-19">
      <p>
        NXGEN Premier League ("NXGEN", "we", "us") is committed to protecting your personal data in accordance with <strong>Republic Act No. 10173 — the Data Privacy Act of 2012</strong>, its Implementing Rules and Regulations, and the issuances of the National Privacy Commission (NPC).
      </p>
