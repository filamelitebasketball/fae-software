      ...
      <div className="nav-ctas">
        ...
        <Sheet>
          <SheetTrigger asChild>
            <button className="btn btn-ghost btn-sm md:hidden" aria-label="Open menu"><Menu className="h-4 w-4" /></button>
          </SheetTrigger>
    ...
    <footer className="site-footer">
      <div className="fi">
        <div className="fbrand">
          ...
          <p className="fcopy">Four divisions. One court. One legacy. F.A.E. Court, Lipa City, Batangas.</p>
        </div>
        ...
        <div className="flinks">
          <div className="flink-group">
            ...
            <a href="https://instagram.com/NXGENPREMIERELEAGUE" target="_blank" rel="noopener noreferrer">Instagram</a>
            <a href="https://www.facebook.com/profile.php?id=61590655296483" target="_blank" rel="noopener noreferrer">Facebook</a>
            <a href="https://www.youtube.com/@NXGENPREMIERELEAGUE" target="_blank" rel="noopener noreferrer">YouTube</a>
            <a href="https://www.tiktok.com/@NXGENPREMIERELEAGUE" target="_blank" rel="noopener noreferrer">TikTok</a>
          </div>
        </div>
      </div>
      <div className="flegal">
        <span>© 2026 NXGEN Premier League. All rights reserved.</span>
