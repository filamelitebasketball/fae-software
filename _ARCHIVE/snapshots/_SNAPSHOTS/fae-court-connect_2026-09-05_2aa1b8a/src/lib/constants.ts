...
export const SITE_NAME = "FAE Court Website";
...
export const FAQ: FaqItem[] = [
  ...
  { question: "How do I join a Filam Elite team?", answer: "Go to the Teams page and sign up for tryouts. Tryouts run monthly on the home floor. Roster spots open when a season closes." },
];
