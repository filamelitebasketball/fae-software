...
export const Route = createFileRoute("/legal/terms")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://nxgenpremierleague.lovable.app/legal/terms" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
    links: [{ rel: "canonical", href: "https://nxgenpremierleague.lovable.app/legal/terms" }],
  }),
  component: () => (
    <LegalDoc title="Terms of Service" updated="2026-01-01">
      <p>
        ...
        and competitions. NXGEN Premier League ("NXGEN", "the League", "we") operates out of F.A.E. Court, Lipa City,
        Batangas, Philippines. By creating an account, registering for a division, entering the venue, or participating in
        any League activity, you agree to be bound by these Terms.
      </p>
      <p>
      ...
      <h2>2. Payment Policy &amp; Refund Terms</h2>
      <p>
      ...
      <p>
        <strong>All payments are non-refundable once the registration is confirmed.</strong> This includes withdrawal by a
        player or team, failure to appear for scheduled games, suspension or expulsion for misconduct, and loss of interest
        in continuing the season. Fees cover operating costs — venue, officials, equipment, insurance administration, and
        production — that are committed in advance and cannot be recovered.
      </p>
      <p>
        Where the League cancels an entire division before the first scheduled game, affected registrants may receive a
        credit or refund at the League's discretion, as described in the Refund Policy. Wallet balances, café charges, and
        merchandise purchases follow the same policy and are reconciled in-venue.
      </p>
      ...
      <p>
        Games and events are photographed, recorded, and livestreamed. By participating, you grant NXGEN the right to
        broadcast, publish, and use your name, image, likeness, and statistics for League coverage, promotion, and
        sponsorship materials, without additional compensation.
      </p>

      <h2>6. League Authority &amp; Rule Changes</h2>
      <p>
