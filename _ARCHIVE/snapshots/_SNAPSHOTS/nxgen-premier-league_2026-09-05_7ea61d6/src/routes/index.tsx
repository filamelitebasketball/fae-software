...
type SiteSponsor = { name: string; logo_url: string; website_url: string; active: boolean };

function useSiteSettings() {
  const [s, setS] = useState<{ hero_badge_text: string; payment_note: string; sponsors: SiteSponsor[] }>({
  ...
  useEffect(() => {
    ...
    void supabase
      .from("site_settings")
      .select("key,value")
      .in("key", ["hero_badge_text", "payment_note", "sponsors"])
      .then(({ data }) => {
        if (!ok || !data) return;
        const m = new Map(data.map((r) => [r.key, r.value as unknown]));
        setS((prev) => ({
          hero_badge_text: typeof m.get("hero_badge_text") === "string" && m.get("hero_badge_text") ? String(m.get("hero_badge_text")) : prev.hero_badge_text,
          payment_note: typeof m.get("payment_note") === "string" && m.get("payment_note") ? String(m.get("payment_note")) : prev.payment_note,
          sponsors: Array.isArray(m.get("sponsors")) ? (m.get("sponsors") as SiteSponsor[]) : [],
        }));
      });
    return () => { ok = false; };
  }, []);
...
const DIVISION_CARDS = [
  { slug: "rising-stars", title: "Rising Stars", meta: ["5v5 · 10-MIN QUARTERS", "AGES 9U–21U"], fee: "₱30,000", per: "/ team", slots: "TBA",
    logo: risingStarLogo.url },
  { slug: "legacy", title: "Legacy", meta: ["5v5 · 12-MIN QUARTERS", "AGES 21+"], fee: "₱35,000", per: "/ team", slots: "TBA",
    logo: legacyLogo.url },
  { slug: "3x3", title: "3×3", meta: ["FIBA RULES · HALF COURT", "KIDS · TEENS · ADULTS"], fee: "₱8,000", per: "/ team", slots: "TBA",
    logo: threeXThreeLogo.url },
  { slug: "king-of-the-court", title: "King of the Court", meta: ["1v1 · SINGLE ELIMINATION", "KIDS · TEENS · ADULTS"], fee: "₱2,000", per: "/ player", slots: "TBA",
    logo: kotcLogo.url },
];
        ...
        <div className="div-grid">
          ...
          {DIVISION_CARDS.map((d) => (
            <Link key={d.slug} to="/divisions/$slug" params={{ slug: d.slug }} className="div-card">
              ...
              <div className="d-fee">{d.fee}<span style={{ fontSize: 10, color: "var(--silver-d)", fontFamily: "var(--fm)", fontWeight: 400 }}> {d.per}</span></div>
        ...
        <div className="card r3 d3" style={{ overflow: "hidden", padding: embedFailed ? 28 : 0 }}>
          {embedFailed ? (
            ...
            <iframe
              ...
              src={`https://www.facebook.com/plugins/page.php?href=${encodeURIComponent(FB_URL)}&tabs=timeline&width=640&height=460&adapt_container_width=true`}
      ...
      <div className="container">
        ...
        <div className="cg r3 d2" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
          <div className="cc">
            ...
            <p style={{ fontSize: 13, color: "var(--silver-d)", lineHeight: 1.7, marginBottom: 14 }}>
              <strong style={{ color: "var(--paint)", fontSize: 14, fontWeight: 700, display: "flex", alignItems: "center", gap: 6, marginBottom: 3 }}>
                <PinIcon />F.A.E. Court, Lipa City
              </strong>
              Lipa City, Batangas<br />Philippines
            </p>
          ...
          <div className="cc">
            ...
            <a href="mailto:hello@nxgenleague.com" className="clink"><S><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></S>hello@nxgenleague.com</a>
            <p style={{ fontSize: 11, color: "var(--silver-d)", marginTop: 6, lineHeight: 1.6 }}>(Response within 24-48 hours)</p>
            <a href="tel:+639175018835" className="clink"><S d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.41 2 2 0 0 1 3.6 1.21h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />+63 917 501 8835</a>
          </div>
          <div className="cc">
            <h3><S d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />Follow</h3>
            <a href="https://instagram.com/NXGENPREMIERELEAGUE" target="_blank" rel="noreferrer" className="socl">
              <S d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37zM17.5 6.5h.01" /><span className="sn">Instagram</span>
            </a>
            <a href="https://www.tiktok.com/@NXGENPREMIERELEAGUE" target="_blank" rel="noreferrer" className="socl">
              <S d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5" /><span className="sn">TikTok</span>
            </a>
            <a href="https://www.facebook.com/profile.php?id=61590655296483" target="_blank" rel="noreferrer" className="socl">
              <S d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /><span className="sn">Facebook</span>
            </a>
            <a href="https://www.youtube.com/@NXGENPREMIERELEAGUE" target="_blank" rel="noreferrer" className="socl">
          ...
          <div className="cc">
            ...
            <p style={{ fontSize: 13, color: "var(--paint)", lineHeight: 1.8 }}>GCash: <span className="mono" style={{ color: "var(--gold-l)" }} data-no-countup>+639175018835</span></p>
  ...
  return (
    <>
      ...
      <main>
        ...
        <Divisions />
        <Games games={liveGames ?? []} />
        <Leaderboards boards={boards} />
        <PlayerOfTheGame />
        <Livestream />


        <Contact paymentNote={settings.payment_note} />
