...
| Quality | Original (no re-encode, fastest), 1080p, 720p, 480p · High / Standard / Small file |
| Exports | Highlight reel (vertical 9:16 for Reels/TikTok or 16:9), top N rallies, per-rally clips, full game, PNG watermark |
...
| Detection | Sensitivity, min hits, max gap, pre/post roll, require court motion, ignore edges % |
